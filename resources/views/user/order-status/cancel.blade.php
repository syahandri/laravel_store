               ...
               <div class="card small rounded-4 mb-3 border-0 p-3 shadow">
                  <div class="row justify-content-between align-items-end">
                     <div class="col-12 col-md-6">
                        ...
                        <p class="my-0">Alasan Dibatalkan: <span class="text-danger text-capitalize fw-semibold">{{ $order->reason }}</span></p>
                     </div>
                     <div class="col-12 col-md-6 text-start text-md-end">
                        <p class="my-0">Tanggal Pesan: {{ $order->order_date }}</p>
                        <p class="my-0">Tanggal Dibatalkan: {{ $order->created_at }}</p>
                     </div>
                  </div>
                  <hr class="my-2">
